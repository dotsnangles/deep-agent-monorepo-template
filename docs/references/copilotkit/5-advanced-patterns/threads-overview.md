...
- **Plan production self-hosting:** [Self-Hosting Enterprise Intelligence](/premium/self-hosting) — work with CopilotKit Engineering to run the Threads platform in your Kubernetes environment
